...
const CardDescripcion = ({expEmpresa}) => {
  return (
    <div className="row">
    <div className="col-2 justify-content-end d-flex">
        <img src={expEmpresa.logoEmpresa} alt="" width='70px' height='70px'/>
    </div>
    <div className="col-10">
        <h3 className="title fs-3">{expEmpresa.titulo}</h3>
        <p className="text-color">{expEmpresa.tituloEmpresa} | {expEmpresa.fechas}</p>
            <ul className="row list-unstyled text-color">

               { expEmpresa.listaTecnologias.map((tecnologia, index) => {
                     return (
